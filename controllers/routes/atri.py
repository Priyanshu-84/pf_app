...
class Atri:
	def __init__(self, state: Any):
		...
		self.FlexHome = state["FlexHome"]
		self.FlexBlock1 = state["FlexBlock1"]
		self.FlexBox11 = state["FlexBox11"]
		self.FlexBox12 = state["FlexBox12"]
		self.FlexBlock2 = state["FlexBlock2"]
		self.FlexBox21 = state["FlexBox21"]
		self.FlexHead = state["FlexHead"]
		self.FlexBody = state["FlexBody"]
		self.FlexButton = state["FlexButton"]
		self.FlexBox22 = state["FlexBox22"]
		self.FlexBlock3 = state["FlexBlock3"]
		self.FlexBox31 = state["FlexBox31"]
		self.FlexBox32 = state["FlexBox32"]
		self.FlexPhoto1 = state["FlexPhoto1"]
		self.FlexPhoto2 = state["FlexPhoto2"]
		self.FlexPhoto3 = state["FlexPhoto3"]
		self.FlexPhoto4 = state["FlexPhoto4"]
		self.FlexBlock4 = state["FlexBlock4"]
		self.FlexBox41 = state["FlexBox41"]
		self.FlexBox42 = state["FlexBox42"]
		self.ServicePart1 = state["ServicePart1"]
		self.FlexServicehead1 = state["FlexServicehead1"]
		self.FlexServiceicon1 = state["FlexServiceicon1"]
		self.Flex27 = state["Flex27"]
		self.Flex28 = state["Flex28"]
		self.ServicePart2 = state["ServicePart2"]
		self.Flex40 = state["Flex40"]
		self.Flex41 = state["Flex41"]
		self.FlexServiceicon2 = state["FlexServiceicon2"]
		self.FlexServicehead2 = state["FlexServicehead2"]
		self.ServicePart3 = state["ServicePart3"]
		self.Flex45 = state["Flex45"]
		self.Flex46 = state["Flex46"]
		self.FlexServiceicon3 = state["FlexServiceicon3"]
		self.FlexServicehead3 = state["FlexServicehead3"]
		self.FlexBlock5 = state["FlexBlock5"]
		self.FlexBox52 = state["FlexBox52"]
		self.FlexGallery = state["FlexGallery"]
		...
		self.NavButton = state["NavButton"]
		self.FlexBox51 = state["FlexBox51"]
		self.Flexviewallprojects = state["Flexviewallprojects"]
		self.Flex54 = state["Flex54"]
		self.FlexHead5 = state["FlexHead5"]
		self.FlexDescription5 = state["FlexDescription5"]
		self.FlexBlock6 = state["FlexBlock6"]
		...
		self.FlexBlock7 = state["FlexBlock7"]
		self.FlexBox71 = state["FlexBox71"]
		self.Flex131 = state["Flex131"]
		self.Flex132 = state["Flex132"]
		self.FlexBox72 = state["FlexBox72"]
		self.Flex133 = state["Flex133"]
		self.Flex130 = state["Flex130"]
		self.FlexBlock8 = state["FlexBlock8"]
		self.FlexBox81 = state["FlexBox81"]
		self.FlexEducation = state["FlexEducation"]
		self.FlexEducationbody = state["FlexEducationbody"]
		self.Educationbody1 = state["Educationbody1"]
		self.Educationbody11 = state["Educationbody11"]
		self.Educationbody12 = state["Educationbody12"]
		self.Educationbody2 = state["Educationbody2"]
		self.Flex155 = state["Flex155"]
		self.Flex156 = state["Flex156"]
		self.Educationbody3 = state["Educationbody3"]
		self.Flex158 = state["Flex158"]
		self.Flex159 = state["Flex159"]
		self.FlexBox82 = state["FlexBox82"]
		...
		self.FlexBlock9 = state["FlexBlock9"]
		self.Flex200 = state["Flex200"]
		self.Flex201 = state["Flex201"]
		self.FlexBlock10 = state["FlexBlock10"]
		self.FlexBox101 = state["FlexBox101"]
		self.FlexBox102 = state["FlexBox102"]
		self.Flex206 = state["Flex206"]
		self.Flex207 = state["Flex207"]
		self.FlexBlock11 = state["FlexBlock11"]
		...
		self.PortfolioCreator = state["PortfolioCreator"]
		self.About = state["About"]
		self.Services = state["Services"]
		self.Products = state["Products"]
		self.Blog = state["Blog"]
		self.Book_a_Call = state["Book_a_Call"]
		self.Heading2 = state["Heading2"]
		self.Heading1 = state["Heading1"]
		self.Description = state["Description"]
		self.BookButton = state["BookButton"]
		self.Download_CV = state["Download_CV"]
		self.Photo = state["Photo"]
		self.Trusted_by = state["Trusted_by"]
		...
		self.ServiceHeader = state["ServiceHeader"]
		self.ServiceDescription = state["ServiceDescription"]
		self.Servicehead1 = state["Servicehead1"]
		self.Serviceicon11 = state["Serviceicon11"]
		...
		self.Serviceicon2 = state["Serviceicon2"]
		self.Servicehead2 = state["Servicehead2"]
		self.TextBox24 = state["TextBox24"]
		self.TextBox25 = state["TextBox25"]
		self.TextBox26 = state["TextBox26"]
		self.TextBox27 = state["TextBox27"]
		self.Serviceicon3 = state["Serviceicon3"]
		self.Servicehead3 = state["Servicehead3"]
		...
		self.View_all_projects = state["View_all_projects"]
		self.Head5 = state["Head5"]
		self.Description5 = state["Description5"]
		...
		self.Uprightarrow = state["Uprightarrow"]
	...
	@property
	def FlexHome(self):
		self._getter_access_tracker["FlexHome"] = {}
		return self._FlexHome
	@FlexHome.setter
	def FlexHome(self, new_state):
		self._setter_access_tracker["FlexHome"] = {}
		global default_state
		self._FlexHome = Flex(new_state, default_state["FlexHome"])

	@property
	def FlexBlock1(self):
		self._getter_access_tracker["FlexBlock1"] = {}
		return self._FlexBlock1
	@FlexBlock1.setter
	def FlexBlock1(self, new_state):
		self._setter_access_tracker["FlexBlock1"] = {}
		global default_state
		self._FlexBlock1 = Flex(new_state, default_state["FlexBlock1"])

	@property
	def FlexBox11(self):
		self._getter_access_tracker["FlexBox11"] = {}
		return self._FlexBox11
	@FlexBox11.setter
	def FlexBox11(self, new_state):
		self._setter_access_tracker["FlexBox11"] = {}
		global default_state
		self._FlexBox11 = Flex(new_state, default_state["FlexBox11"])

	@property
	def FlexBox12(self):
		self._getter_access_tracker["FlexBox12"] = {}
		return self._FlexBox12
	@FlexBox12.setter
	def FlexBox12(self, new_state):
		self._setter_access_tracker["FlexBox12"] = {}
		global default_state
		self._FlexBox12 = Flex(new_state, default_state["FlexBox12"])

	@property
	def FlexBlock2(self):
		self._getter_access_tracker["FlexBlock2"] = {}
		return self._FlexBlock2
	@FlexBlock2.setter
	def FlexBlock2(self, new_state):
		self._setter_access_tracker["FlexBlock2"] = {}
		global default_state
		self._FlexBlock2 = Flex(new_state, default_state["FlexBlock2"])

	@property
	def FlexBox21(self):
		self._getter_access_tracker["FlexBox21"] = {}
		return self._FlexBox21
	@FlexBox21.setter
	def FlexBox21(self, new_state):
		self._setter_access_tracker["FlexBox21"] = {}
		global default_state
		self._FlexBox21 = Flex(new_state, default_state["FlexBox21"])

	@property
	def FlexHead(self):
		self._getter_access_tracker["FlexHead"] = {}
		return self._FlexHead
	@FlexHead.setter
	def FlexHead(self, new_state):
		self._setter_access_tracker["FlexHead"] = {}
		global default_state
		self._FlexHead = Flex(new_state, default_state["FlexHead"])

	@property
	def FlexBody(self):
		self._getter_access_tracker["FlexBody"] = {}
		return self._FlexBody
	@FlexBody.setter
	def FlexBody(self, new_state):
		self._setter_access_tracker["FlexBody"] = {}
		global default_state
		self._FlexBody = Flex(new_state, default_state["FlexBody"])

	@property
	def FlexButton(self):
		self._getter_access_tracker["FlexButton"] = {}
		return self._FlexButton
	@FlexButton.setter
	def FlexButton(self, new_state):
		self._setter_access_tracker["FlexButton"] = {}
		global default_state
		self._FlexButton = Flex(new_state, default_state["FlexButton"])

	@property
	def FlexBox22(self):
		self._getter_access_tracker["FlexBox22"] = {}
		return self._FlexBox22
	@FlexBox22.setter
	def FlexBox22(self, new_state):
		self._setter_access_tracker["FlexBox22"] = {}
		global default_state
		self._FlexBox22 = Flex(new_state, default_state["FlexBox22"])

	@property
	def FlexBlock3(self):
		self._getter_access_tracker["FlexBlock3"] = {}
		return self._FlexBlock3
	@FlexBlock3.setter
	def FlexBlock3(self, new_state):
		self._setter_access_tracker["FlexBlock3"] = {}
		global default_state
		self._FlexBlock3 = Flex(new_state, default_state["FlexBlock3"])

	@property
	def FlexBox31(self):
		self._getter_access_tracker["FlexBox31"] = {}
		return self._FlexBox31
	@FlexBox31.setter
	def FlexBox31(self, new_state):
		self._setter_access_tracker["FlexBox31"] = {}
		global default_state
		self._FlexBox31 = Flex(new_state, default_state["FlexBox31"])

	@property
	def FlexBox32(self):
		self._getter_access_tracker["FlexBox32"] = {}
		return self._FlexBox32
	@FlexBox32.setter
	def FlexBox32(self, new_state):
		self._setter_access_tracker["FlexBox32"] = {}
		global default_state
		self._FlexBox32 = Flex(new_state, default_state["FlexBox32"])

	@property
	def FlexPhoto1(self):
		self._getter_access_tracker["FlexPhoto1"] = {}
		return self._FlexPhoto1
	@FlexPhoto1.setter
	def FlexPhoto1(self, new_state):
		self._setter_access_tracker["FlexPhoto1"] = {}
		global default_state
		self._FlexPhoto1 = Flex(new_state, default_state["FlexPhoto1"])

	@property
	def FlexPhoto2(self):
		self._getter_access_tracker["FlexPhoto2"] = {}
		return self._FlexPhoto2
	@FlexPhoto2.setter
	def FlexPhoto2(self, new_state):
		self._setter_access_tracker["FlexPhoto2"] = {}
		global default_state
		self._FlexPhoto2 = Flex(new_state, default_state["FlexPhoto2"])

	@property
	def FlexPhoto3(self):
		self._getter_access_tracker["FlexPhoto3"] = {}
		return self._FlexPhoto3
	@FlexPhoto3.setter
	def FlexPhoto3(self, new_state):
		self._setter_access_tracker["FlexPhoto3"] = {}
		global default_state
		self._FlexPhoto3 = Flex(new_state, default_state["FlexPhoto3"])

	@property
	def FlexPhoto4(self):
		self._getter_access_tracker["FlexPhoto4"] = {}
		return self._FlexPhoto4
	@FlexPhoto4.setter
	def FlexPhoto4(self, new_state):
		self._setter_access_tracker["FlexPhoto4"] = {}
		global default_state
		self._FlexPhoto4 = Flex(new_state, default_state["FlexPhoto4"])

	@property
	def FlexBlock4(self):
		self._getter_access_tracker["FlexBlock4"] = {}
		return self._FlexBlock4
	@FlexBlock4.setter
	def FlexBlock4(self, new_state):
		self._setter_access_tracker["FlexBlock4"] = {}
		global default_state
		self._FlexBlock4 = Flex(new_state, default_state["FlexBlock4"])

	@property
	def FlexBox41(self):
		self._getter_access_tracker["FlexBox41"] = {}
		return self._FlexBox41
	@FlexBox41.setter
	def FlexBox41(self, new_state):
		self._setter_access_tracker["FlexBox41"] = {}
		global default_state
		self._FlexBox41 = Flex(new_state, default_state["FlexBox41"])

	@property
	def FlexBox42(self):
		self._getter_access_tracker["FlexBox42"] = {}
		return self._FlexBox42
	@FlexBox42.setter
	def FlexBox42(self, new_state):
		self._setter_access_tracker["FlexBox42"] = {}
		global default_state
		self._FlexBox42 = Flex(new_state, default_state["FlexBox42"])

	@property
	def ServicePart1(self):
		self._getter_access_tracker["ServicePart1"] = {}
		return self._ServicePart1
	@ServicePart1.setter
	def ServicePart1(self, new_state):
		self._setter_access_tracker["ServicePart1"] = {}
		global default_state
		self._ServicePart1 = Flex(new_state, default_state["ServicePart1"])

	@property
	def FlexServicehead1(self):
		self._getter_access_tracker["FlexServicehead1"] = {}
		return self._FlexServicehead1
	@FlexServicehead1.setter
	def FlexServicehead1(self, new_state):
		self._setter_access_tracker["FlexServicehead1"] = {}
		global default_state
		self._FlexServicehead1 = Flex(new_state, default_state["FlexServicehead1"])

	@property
	def FlexServiceicon1(self):
		self._getter_access_tracker["FlexServiceicon1"] = {}
		return self._FlexServiceicon1
	@FlexServiceicon1.setter
	def FlexServiceicon1(self, new_state):
		self._setter_access_tracker["FlexServiceicon1"] = {}
		global default_state
		self._FlexServiceicon1 = Flex(new_state, default_state["FlexServiceicon1"])
	...
	@property
	def ServicePart2(self):
		self._getter_access_tracker["ServicePart2"] = {}
		return self._ServicePart2
	@ServicePart2.setter
	def ServicePart2(self, new_state):
		self._setter_access_tracker["ServicePart2"] = {}
		global default_state
		self._ServicePart2 = Flex(new_state, default_state["ServicePart2"])
	...
	@property
	def FlexServiceicon2(self):
		self._getter_access_tracker["FlexServiceicon2"] = {}
		return self._FlexServiceicon2
	@FlexServiceicon2.setter
	def FlexServiceicon2(self, new_state):
		self._setter_access_tracker["FlexServiceicon2"] = {}
		global default_state
		self._FlexServiceicon2 = Flex(new_state, default_state["FlexServiceicon2"])

	@property
	def FlexServicehead2(self):
		self._getter_access_tracker["FlexServicehead2"] = {}
		return self._FlexServicehead2
	@FlexServicehead2.setter
	def FlexServicehead2(self, new_state):
		self._setter_access_tracker["FlexServicehead2"] = {}
		global default_state
		self._FlexServicehead2 = Flex(new_state, default_state["FlexServicehead2"])

	@property
	def ServicePart3(self):
		self._getter_access_tracker["ServicePart3"] = {}
		return self._ServicePart3
	@ServicePart3.setter
	def ServicePart3(self, new_state):
		self._setter_access_tracker["ServicePart3"] = {}
		global default_state
		self._ServicePart3 = Flex(new_state, default_state["ServicePart3"])
	...
	@property
	def FlexServiceicon3(self):
		self._getter_access_tracker["FlexServiceicon3"] = {}
		return self._FlexServiceicon3
	@FlexServiceicon3.setter
	def FlexServiceicon3(self, new_state):
		self._setter_access_tracker["FlexServiceicon3"] = {}
		global default_state
		self._FlexServiceicon3 = Flex(new_state, default_state["FlexServiceicon3"])

	@property
	def FlexServicehead3(self):
		self._getter_access_tracker["FlexServicehead3"] = {}
		return self._FlexServicehead3
	@FlexServicehead3.setter
	def FlexServicehead3(self, new_state):
		self._setter_access_tracker["FlexServicehead3"] = {}
		global default_state
		self._FlexServicehead3 = Flex(new_state, default_state["FlexServicehead3"])

	@property
	def FlexBlock5(self):
		self._getter_access_tracker["FlexBlock5"] = {}
		return self._FlexBlock5
	@FlexBlock5.setter
	def FlexBlock5(self, new_state):
		self._setter_access_tracker["FlexBlock5"] = {}
		global default_state
		self._FlexBlock5 = Flex(new_state, default_state["FlexBlock5"])

	@property
	def FlexBox52(self):
		self._getter_access_tracker["FlexBox52"] = {}
		return self._FlexBox52
	@FlexBox52.setter
	def FlexBox52(self, new_state):
		self._setter_access_tracker["FlexBox52"] = {}
		global default_state
		self._FlexBox52 = Flex(new_state, default_state["FlexBox52"])

	@property
	def FlexGallery(self):
		self._getter_access_tracker["FlexGallery"] = {}
		return self._FlexGallery
	@FlexGallery.setter
	def FlexGallery(self, new_state):
		self._setter_access_tracker["FlexGallery"] = {}
		global default_state
		self._FlexGallery = Flex(new_state, default_state["FlexGallery"])
	...
	@property
	def NavButton(self):
		self._getter_access_tracker["NavButton"] = {}
		return self._NavButton
	@NavButton.setter
	def NavButton(self, new_state):
		self._setter_access_tracker["NavButton"] = {}
		global default_state
		self._NavButton = Flex(new_state, default_state["NavButton"])

	@property
	def FlexBox51(self):
		self._getter_access_tracker["FlexBox51"] = {}
		return self._FlexBox51
	@FlexBox51.setter
	def FlexBox51(self, new_state):
		self._setter_access_tracker["FlexBox51"] = {}
		global default_state
		self._FlexBox51 = Flex(new_state, default_state["FlexBox51"])

	@property
	def Flexviewallprojects(self):
		self._getter_access_tracker["Flexviewallprojects"] = {}
		return self._Flexviewallprojects
	@Flexviewallprojects.setter
	def Flexviewallprojects(self, new_state):
		self._setter_access_tracker["Flexviewallprojects"] = {}
		global default_state
		self._Flexviewallprojects = Flex(new_state, default_state["Flexviewallprojects"])
	...
	@property
	def FlexHead5(self):
		self._getter_access_tracker["FlexHead5"] = {}
		return self._FlexHead5
	@FlexHead5.setter
	def FlexHead5(self, new_state):
		self._setter_access_tracker["FlexHead5"] = {}
		global default_state
		self._FlexHead5 = Flex(new_state, default_state["FlexHead5"])

	@property
	def FlexDescription5(self):
		self._getter_access_tracker["FlexDescription5"] = {}
		return self._FlexDescription5
	@FlexDescription5.setter
	def FlexDescription5(self, new_state):
		self._setter_access_tracker["FlexDescription5"] = {}
		global default_state
		self._FlexDescription5 = Flex(new_state, default_state["FlexDescription5"])

	@property
	def FlexBlock6(self):
		self._getter_access_tracker["FlexBlock6"] = {}
		return self._FlexBlock6
	@FlexBlock6.setter
	def FlexBlock6(self, new_state):
		self._setter_access_tracker["FlexBlock6"] = {}
		global default_state
		self._FlexBlock6 = Flex(new_state, default_state["FlexBlock6"])
	...
	@property
	def FlexBlock7(self):
		self._getter_access_tracker["FlexBlock7"] = {}
		return self._FlexBlock7
	@FlexBlock7.setter
	def FlexBlock7(self, new_state):
		self._setter_access_tracker["FlexBlock7"] = {}
		global default_state
		self._FlexBlock7 = Flex(new_state, default_state["FlexBlock7"])

	@property
	def FlexBox71(self):
		self._getter_access_tracker["FlexBox71"] = {}
		return self._FlexBox71
	@FlexBox71.setter
	def FlexBox71(self, new_state):
		self._setter_access_tracker["FlexBox71"] = {}
		global default_state
		self._FlexBox71 = Flex(new_state, default_state["FlexBox71"])
	...
	@property
	def FlexBox72(self):
		self._getter_access_tracker["FlexBox72"] = {}
		return self._FlexBox72
	@FlexBox72.setter
	def FlexBox72(self, new_state):
		self._setter_access_tracker["FlexBox72"] = {}
		global default_state
		self._FlexBox72 = Flex(new_state, default_state["FlexBox72"])
	...
	@property
	def FlexBlock8(self):
		self._getter_access_tracker["FlexBlock8"] = {}
		return self._FlexBlock8
	@FlexBlock8.setter
	def FlexBlock8(self, new_state):
		self._setter_access_tracker["FlexBlock8"] = {}
		global default_state
		self._FlexBlock8 = Flex(new_state, default_state["FlexBlock8"])

	@property
	def FlexBox81(self):
		self._getter_access_tracker["FlexBox81"] = {}
		return self._FlexBox81
	@FlexBox81.setter
	def FlexBox81(self, new_state):
		self._setter_access_tracker["FlexBox81"] = {}
		global default_state
		self._FlexBox81 = Flex(new_state, default_state["FlexBox81"])

	@property
	def FlexEducation(self):
		self._getter_access_tracker["FlexEducation"] = {}
		return self._FlexEducation
	@FlexEducation.setter
	def FlexEducation(self, new_state):
		self._setter_access_tracker["FlexEducation"] = {}
		global default_state
		self._FlexEducation = Flex(new_state, default_state["FlexEducation"])

	@property
	def FlexEducationbody(self):
		self._getter_access_tracker["FlexEducationbody"] = {}
		return self._FlexEducationbody
	@FlexEducationbody.setter
	def FlexEducationbody(self, new_state):
		self._setter_access_tracker["FlexEducationbody"] = {}
		global default_state
		self._FlexEducationbody = Flex(new_state, default_state["FlexEducationbody"])

	@property
	def Educationbody1(self):
		self._getter_access_tracker["Educationbody1"] = {}
		return self._Educationbody1
	@Educationbody1.setter
	def Educationbody1(self, new_state):
		self._setter_access_tracker["Educationbody1"] = {}
		global default_state
		self._Educationbody1 = Flex(new_state, default_state["Educationbody1"])

	@property
	def Educationbody11(self):
		self._getter_access_tracker["Educationbody11"] = {}
		return self._Educationbody11
	@Educationbody11.setter
	def Educationbody11(self, new_state):
		self._setter_access_tracker["Educationbody11"] = {}
		global default_state
		self._Educationbody11 = Flex(new_state, default_state["Educationbody11"])

	@property
	def Educationbody12(self):
		self._getter_access_tracker["Educationbody12"] = {}
		return self._Educationbody12
	@Educationbody12.setter
	def Educationbody12(self, new_state):
		self._setter_access_tracker["Educationbody12"] = {}
		global default_state
		self._Educationbody12 = Flex(new_state, default_state["Educationbody12"])

	@property
	def Educationbody2(self):
		self._getter_access_tracker["Educationbody2"] = {}
		return self._Educationbody2
	@Educationbody2.setter
	def Educationbody2(self, new_state):
		self._setter_access_tracker["Educationbody2"] = {}
		global default_state
		self._Educationbody2 = Flex(new_state, default_state["Educationbody2"])
	...
	@property
	def Educationbody3(self):
		self._getter_access_tracker["Educationbody3"] = {}
		return self._Educationbody3
	@Educationbody3.setter
	def Educationbody3(self, new_state):
		self._setter_access_tracker["Educationbody3"] = {}
		global default_state
		self._Educationbody3 = Flex(new_state, default_state["Educationbody3"])
	...
	@property
	def FlexBox82(self):
		self._getter_access_tracker["FlexBox82"] = {}
		return self._FlexBox82
	@FlexBox82.setter
	def FlexBox82(self, new_state):
		self._setter_access_tracker["FlexBox82"] = {}
		global default_state
		self._FlexBox82 = Flex(new_state, default_state["FlexBox82"])
	...
	@property
	def FlexBlock9(self):
		self._getter_access_tracker["FlexBlock9"] = {}
		return self._FlexBlock9
	@FlexBlock9.setter
	def FlexBlock9(self, new_state):
		self._setter_access_tracker["FlexBlock9"] = {}
		global default_state
		self._FlexBlock9 = Flex(new_state, default_state["FlexBlock9"])
	...
	@property
	def FlexBlock10(self):
		self._getter_access_tracker["FlexBlock10"] = {}
		return self._FlexBlock10
	@FlexBlock10.setter
	def FlexBlock10(self, new_state):
		self._setter_access_tracker["FlexBlock10"] = {}
		global default_state
		self._FlexBlock10 = Flex(new_state, default_state["FlexBlock10"])

	@property
	def FlexBox101(self):
		self._getter_access_tracker["FlexBox101"] = {}
		return self._FlexBox101
	@FlexBox101.setter
	def FlexBox101(self, new_state):
		self._setter_access_tracker["FlexBox101"] = {}
		global default_state
		self._FlexBox101 = Flex(new_state, default_state["FlexBox101"])

	@property
	def FlexBox102(self):
		self._getter_access_tracker["FlexBox102"] = {}
		return self._FlexBox102
	@FlexBox102.setter
	def FlexBox102(self, new_state):
		self._setter_access_tracker["FlexBox102"] = {}
		global default_state
		self._FlexBox102 = Flex(new_state, default_state["FlexBox102"])
	...
	@property
	def FlexBlock11(self):
		self._getter_access_tracker["FlexBlock11"] = {}
		return self._FlexBlock11
	@FlexBlock11.setter
	def FlexBlock11(self, new_state):
		self._setter_access_tracker["FlexBlock11"] = {}
		global default_state
		self._FlexBlock11 = Flex(new_state, default_state["FlexBlock11"])
	...
	@property
	def PortfolioCreator(self):
		self._getter_access_tracker["PortfolioCreator"] = {}
		return self._PortfolioCreator
	@PortfolioCreator.setter
	def PortfolioCreator(self, new_state):
		self._setter_access_tracker["PortfolioCreator"] = {}
		global default_state
		self._PortfolioCreator = TextBox(new_state, default_state["PortfolioCreator"])
	...
	@property
	def Products(self):
		self._getter_access_tracker["Products"] = {}
		return self._Products
	@Products.setter
	def Products(self, new_state):
		self._setter_access_tracker["Products"] = {}
		global default_state
		self._Products = TextBox(new_state, default_state["Products"])
	...
	def Book_a_Call(self):
		self._getter_access_tracker["Book_a_Call"] = {}
		return self._Book_a_Call
	@Book_a_Call.setter
	def Book_a_Call(self, new_state):
		self._setter_access_tracker["Book_a_Call"] = {}
		global default_state
		self._Book_a_Call = TextBox(new_state, default_state["Book_a_Call"])

	@property
	def Heading2(self):
		self._getter_access_tracker["Heading2"] = {}
		return self._Heading2
	@Heading2.setter
	def Heading2(self, new_state):
		self._setter_access_tracker["Heading2"] = {}
		global default_state
		self._Heading2 = TextBox(new_state, default_state["Heading2"])

	@property
	def Heading1(self):
		self._getter_access_tracker["Heading1"] = {}
		return self._Heading1
	@Heading1.setter
	def Heading1(self, new_state):
		self._setter_access_tracker["Heading1"] = {}
		global default_state
		self._Heading1 = TextBox(new_state, default_state["Heading1"])
	...
	@Description.setter
	def Description(self, new_state):
		self._setter_access_tracker["Description"] = {}
		global default_state
		self._Description = TextBox(new_state, default_state["Description"])

	@property
	def BookButton(self):
		self._getter_access_tracker["BookButton"] = {}
		return self._BookButton
	@BookButton.setter
	def BookButton(self, new_state):
		self._setter_access_tracker["BookButton"] = {}
		global default_state
		self._BookButton = Button(new_state, default_state["BookButton"])

	@property
	def Download_CV(self):
		self._getter_access_tracker["Download_CV"] = {}
		return self._Download_CV
	@Download_CV.setter
	def Download_CV(self, new_state):
		self._setter_access_tracker["Download_CV"] = {}
		global default_state
		self._Download_CV = TextBox(new_state, default_state["Download_CV"])

	@property
	def Photo(self):
		self._getter_access_tracker["Photo"] = {}
		return self._Photo
	@Photo.setter
	def Photo(self, new_state):
		self._setter_access_tracker["Photo"] = {}
		global default_state
		self._Photo = Image(new_state, default_state["Photo"])

	@property
	def Trusted_by(self):
		self._getter_access_tracker["Trusted_by"] = {}
		return self._Trusted_by
	@Trusted_by.setter
	def Trusted_by(self, new_state):
		self._setter_access_tracker["Trusted_by"] = {}
		global default_state
		self._Trusted_by = TextBox(new_state, default_state["Trusted_by"])
	...
	@property
	def ServiceHeader(self):
		self._getter_access_tracker["ServiceHeader"] = {}
		return self._ServiceHeader
	@ServiceHeader.setter
	def ServiceHeader(self, new_state):
		self._setter_access_tracker["ServiceHeader"] = {}
		global default_state
		self._ServiceHeader = TextBox(new_state, default_state["ServiceHeader"])

	@property
	def ServiceDescription(self):
		self._getter_access_tracker["ServiceDescription"] = {}
		return self._ServiceDescription
	@ServiceDescription.setter
	def ServiceDescription(self, new_state):
		self._setter_access_tracker["ServiceDescription"] = {}
		global default_state
		self._ServiceDescription = TextBox(new_state, default_state["ServiceDescription"])

	@property
	def Servicehead1(self):
		self._getter_access_tracker["Servicehead1"] = {}
		return self._Servicehead1
	@Servicehead1.setter
	def Servicehead1(self, new_state):
		self._setter_access_tracker["Servicehead1"] = {}
		global default_state
		self._Servicehead1 = TextBox(new_state, default_state["Servicehead1"])

	@property
	def Serviceicon11(self):
		self._getter_access_tracker["Serviceicon11"] = {}
		return self._Serviceicon11
	@Serviceicon11.setter
	def Serviceicon11(self, new_state):
		self._setter_access_tracker["Serviceicon11"] = {}
		global default_state
		self._Serviceicon11 = Image(new_state, default_state["Serviceicon11"])
	...
	@property
	def Serviceicon2(self):
		self._getter_access_tracker["Serviceicon2"] = {}
		return self._Serviceicon2
	@Serviceicon2.setter
	def Serviceicon2(self, new_state):
		self._setter_access_tracker["Serviceicon2"] = {}
		global default_state
		self._Serviceicon2 = Image(new_state, default_state["Serviceicon2"])

	@property
	def Servicehead2(self):
		self._getter_access_tracker["Servicehead2"] = {}
		return self._Servicehead2
	@Servicehead2.setter
	def Servicehead2(self, new_state):
		self._setter_access_tracker["Servicehead2"] = {}
		global default_state
		self._Servicehead2 = TextBox(new_state, default_state["Servicehead2"])
	...
	@property
	def Serviceicon3(self):
		self._getter_access_tracker["Serviceicon3"] = {}
		return self._Serviceicon3
	@Serviceicon3.setter
	def Serviceicon3(self, new_state):
		self._setter_access_tracker["Serviceicon3"] = {}
		global default_state
		self._Serviceicon3 = Image(new_state, default_state["Serviceicon3"])

	@property
	def Servicehead3(self):
		self._getter_access_tracker["Servicehead3"] = {}
		return self._Servicehead3
	@Servicehead3.setter
	def Servicehead3(self, new_state):
		self._setter_access_tracker["Servicehead3"] = {}
		global default_state
		self._Servicehead3 = TextBox(new_state, default_state["Servicehead3"])
	...
	@property
	def Prev(self):
		self._getter_access_tracker["Prev"] = {}
		return self._Prev
	@Prev.setter
	def Prev(self, new_state):
		self._setter_access_tracker["Prev"] = {}
		global default_state
		self._Prev = Button(new_state, default_state["Prev"])

	@property
	def Next(self):
		self._getter_access_tracker["Next"] = {}
		return self._Next
	@Next.setter
	def Next(self, new_state):
		self._setter_access_tracker["Next"] = {}
		global default_state
		self._Next = Button(new_state, default_state["Next"])

	@property
	def View_all_projects(self):
		self._getter_access_tracker["View_all_projects"] = {}
		return self._View_all_projects
	@View_all_projects.setter
	def View_all_projects(self, new_state):
		self._setter_access_tracker["View_all_projects"] = {}
		global default_state
		self._View_all_projects = Button(new_state, default_state["View_all_projects"])

	@property
	def Head5(self):
		self._getter_access_tracker["Head5"] = {}
		return self._Head5
	@Head5.setter
	def Head5(self, new_state):
		self._setter_access_tracker["Head5"] = {}
		global default_state
		self._Head5 = TextBox(new_state, default_state["Head5"])

	@property
	def Description5(self):
		self._getter_access_tracker["Description5"] = {}
		return self._Description5
	@Description5.setter
	def Description5(self, new_state):
		self._setter_access_tracker["Description5"] = {}
		global default_state
		self._Description5 = TextBox(new_state, default_state["Description5"])
	...
	def Book(self, new_state):
		...
		global default_state
		self._Book = Image(new_state, default_state["Book"])
	...
	def Education(self, new_state):
		...
		global default_state
		self._Education = TextBox(new_state, default_state["Education"])
	...
	@property
	def Uprightarrow(self):
		self._getter_access_tracker["Uprightarrow"] = {}
		return self._Uprightarrow
	@Uprightarrow.setter
	def Uprightarrow(self, new_state):
		self._setter_access_tracker["Uprightarrow"] = {}
		global default_state
		self._Uprightarrow = TextBox(new_state, default_state["Uprightarrow"])
	...
	def _to_json_fields(self):
		return {
			"FlexHome": self._FlexHome,
			"FlexBlock1": self._FlexBlock1,
			"FlexBox11": self._FlexBox11,
			"FlexBox12": self._FlexBox12,
			"FlexBlock2": self._FlexBlock2,
			"FlexBox21": self._FlexBox21,
			"FlexHead": self._FlexHead,
			"FlexBody": self._FlexBody,
			"FlexButton": self._FlexButton,
			"FlexBox22": self._FlexBox22,
			"FlexBlock3": self._FlexBlock3,
			"FlexBox31": self._FlexBox31,
			"FlexBox32": self._FlexBox32,
			"FlexPhoto1": self._FlexPhoto1,
			"FlexPhoto2": self._FlexPhoto2,
			"FlexPhoto3": self._FlexPhoto3,
			"FlexPhoto4": self._FlexPhoto4,
			"FlexBlock4": self._FlexBlock4,
			"FlexBox41": self._FlexBox41,
			"FlexBox42": self._FlexBox42,
			"ServicePart1": self._ServicePart1,
			"FlexServicehead1": self._FlexServicehead1,
			"FlexServiceicon1": self._FlexServiceicon1,
			"Flex27": self._Flex27,
			"Flex28": self._Flex28,
			"ServicePart2": self._ServicePart2,
			"Flex40": self._Flex40,
			"Flex41": self._Flex41,
			"FlexServiceicon2": self._FlexServiceicon2,
			"FlexServicehead2": self._FlexServicehead2,
			"ServicePart3": self._ServicePart3,
			"Flex45": self._Flex45,
			"Flex46": self._Flex46,
			"FlexServiceicon3": self._FlexServiceicon3,
			"FlexServicehead3": self._FlexServicehead3,
			"FlexBlock5": self._FlexBlock5,
			"FlexBox52": self._FlexBox52,
			"FlexGallery": self._FlexGallery,
			"Flex60": self._Flex60,
			"Flex61": self._Flex61,
			"Flex62": self._Flex62,
			"Flex65": self._Flex65,
			...
			"Flex72": self._Flex72,
			"Flex73": self._Flex73,
			"NavButton": self._NavButton,
			"FlexBox51": self._FlexBox51,
			"Flexviewallprojects": self._Flexviewallprojects,
			"Flex54": self._Flex54,
			"FlexHead5": self._FlexHead5,
			"FlexDescription5": self._FlexDescription5,
			"FlexBlock6": self._FlexBlock6,
			...
			"FlexBlock7": self._FlexBlock7,
			"FlexBox71": self._FlexBox71,
			"Flex131": self._Flex131,
			"Flex132": self._Flex132,
			"FlexBox72": self._FlexBox72,
			"Flex133": self._Flex133,
			"Flex130": self._Flex130,
			"FlexBlock8": self._FlexBlock8,
			"FlexBox81": self._FlexBox81,
			"FlexEducation": self._FlexEducation,
			"FlexEducationbody": self._FlexEducationbody,
			"Educationbody1": self._Educationbody1,
			"Educationbody11": self._Educationbody11,
			"Educationbody12": self._Educationbody12,
			"Educationbody2": self._Educationbody2,
			"Flex155": self._Flex155,
			"Flex156": self._Flex156,
			"Educationbody3": self._Educationbody3,
			"Flex158": self._Flex158,
			"Flex159": self._Flex159,
			"FlexBox82": self._FlexBox82,
			...
			"FlexBlock9": self._FlexBlock9,
			"Flex200": self._Flex200,
			"Flex201": self._Flex201,
			"FlexBlock10": self._FlexBlock10,
			"FlexBox101": self._FlexBox101,
			"FlexBox102": self._FlexBox102,
			"Flex206": self._Flex206,
			"Flex207": self._Flex207,
			"FlexBlock11": self._FlexBlock11,
			...
			"PortfolioCreator": self._PortfolioCreator,
			"About": self._About,
			"Services": self._Services,
			"Products": self._Products,
			"Blog": self._Blog,
			"Book_a_Call": self._Book_a_Call,
			"Heading2": self._Heading2,
			"Heading1": self._Heading1,
			"Description": self._Description,
			"BookButton": self._BookButton,
			"Download_CV": self._Download_CV,
			"Photo": self._Photo,
			"Trusted_by": self._Trusted_by,
			"Logoipsum1": self._Logoipsum1,
			"Logoipsum2": self._Logoipsum2,
			"Logoipsum3": self._Logoipsum3,
			"Logoipsum4": self._Logoipsum4,
			"ServiceHeader": self._ServiceHeader,
			"ServiceDescription": self._ServiceDescription,
			"Servicehead1": self._Servicehead1,
			"Serviceicon11": self._Serviceicon11,
			...
			"Serviceicon2": self._Serviceicon2,
			"Servicehead2": self._Servicehead2,
			"TextBox24": self._TextBox24,
			"TextBox25": self._TextBox25,
			"TextBox26": self._TextBox26,
			"TextBox27": self._TextBox27,
			"Serviceicon3": self._Serviceicon3,
			"Servicehead3": self._Servicehead3,
			...
			"Prev": self._Prev,
			"Next": self._Next,
			"View_all_projects": self._View_all_projects,
			"Head5": self._Head5,
			"Description5": self._Description5,
			...
			"Uprightarrow": self._Uprightarrow,
